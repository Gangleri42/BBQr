...
const (
	...
	// TypeShamir carries one share of a k-of-n Shamir split, the
	// extension SHAMIR.md specifies and package shamir implements. A
	// decoder without the extension must not present the payload as
	// the data: a single share is never the user's data.
	TypeShamir = 'M'
)
