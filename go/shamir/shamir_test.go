...
// the 256 raw random bytes map onto all 256 share values, so a lone
// share value is consistent with every secret equally, each explained
// by exactly one random byte, hedge included.
